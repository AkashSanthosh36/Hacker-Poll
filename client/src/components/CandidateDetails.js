...
import { addCandidateStyles } from '../componentsStyling/CandidateDetails'
...
function CandidateDetails(props) {
    ...
    const handleAddSkillDialogOpen = () => {
        setAddSkillDialogOpen(true);
    };
    
    const handleAddSkillDialogClose = () => {
        setSkillName('')
        setAddSkillDialogOpen(false);
    };

    const handleSetSkills = () => {
        setSkills([...skills, {skillName: skillName, level: 0}])
        setAddSkillDialogOpen(false)
    }
                ...
                >
                    { formik  => (
                        <Form>
                            ...
                            <Button className={classes.addSkillButton} onClick={handleAddSkillDialogOpen} variant="contained" color="primary">Add Skill</Button>

                            <Button className={classes.submitButton} type="submit" fullWidth>Add</Button>
                        </Form>
                    )}
                </Formik>
            </Card>

            <Dialog open={addSkillDialogOpen} scroll="paper" onClose={handleAddSkillDialogClose} fullWidth aria-labelledby="form-dialog-title">
              ...
              <DialogTitle id="form-dialog-title">
                  <form>
                    ...
                    <Button style={{ marginLeft: '40%' }} variant="contained" color="primary" onClick={handleSetSkills}>Add Skill</Button>
                  </form>
              </DialogTitle>
              
              <DialogActions>
                <Button onClick={handleAddSkillDialogClose} color="primary">
                  Close
                </Button>
              </DialogActions>
            </Dialog>
